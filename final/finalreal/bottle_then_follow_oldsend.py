...
class ObjectTrackingNode(Node):
    def __init__(self):
        ...
        # self.timer = self.create_timer(0.5, self.bottle_found)
        self.detected=False
    ...
    def shutdown_node(self):
        # Set the shutdown flag and call rclpy.shutdown()
    ...
    def destroy_node(self):
        self.webcam_video.release()
        cv2.destroyAllWindows()
        self.get_logger().info("Resources released and node destroyed.")
...
def main(args=None):
    ...
    # if current_state >= 1:  # Finding bottle
        ...
        object_detect.spin()
    # if current_state >= 2:  # Bottle found, generate and find path
        rclpy.init(args=args)
