...
class PathPlanner(Node):
    def __init__(self):
        ...
        self.robot_position = (1.37, 2.17)  # Initial position (x, y)
        ...
        self.start_map = (1.37, 2.17)  # Map coordinates (x, y)
        ...
        self.grid_map = self.load_and_preprocess_map('finalsim_merged_lidar_map.csv')
    ...
    def map_to_grid(self, map_coords):
        ...
        grid_x = int((map_x - self.grid_origin[0]) / self.grid_resolution)
        grid_y = int((map_y - self.grid_origin[1]) / self.grid_resolution)
