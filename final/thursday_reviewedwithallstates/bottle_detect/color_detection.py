...
while True:
    ...
    if len(mask_contours) != 0:
        ...
        if cv2.contourArea(largest_contour) > 500:  # Ignore small objects
            ...
            cv2.rectangle(mask, (x, y), (x + w, y + h), (0, 255, 0), 2)  # Green color, thickness 2
            ...
            cv2.circle(mask, (cx, cy), 5, (255, 0, 0), -1)  # Blue dot for object center
            ...
            if error <-300:  # Object is to the right of the center
                vl = 0.05
                vr = 0.08
            elif error >300:  # Object is to the left of the center
                vl = 0.08
                vr = 0.05
