...
const float kp_line = 0.1;
const float ki_line = 0.009;
const float kd_line = 0.009;
float error_line, sumError_line= 0, previousError_line= 0, differenceError_line = 0, currentError_line;

const float outer_eye_weight = 0.7;  //line follower -- weight of outer eyes
const float inner_eye_weight = 0.3;   //line follower -- weight of inner eyes
const float middle_eye_weight = 0.2;  //line follower -- weight of the middle eye
...
// Combine sensor readings into a unique value for switch-case
  ...
  switch (sensorState) {
    case 0b10000:  // 1 0 0 0 0
      currentError_line = -1.6;
      break;
    case 0b11110:  // 1 1 1 1 0
      currentError_line = -1.2;
      break;
