...
// void goCircle_clockwise(float radius, float portion) {
//   //around a circle of 1m radius, vl=1.2vr
//   float required_length = 2*3.14*radius*portion;
//   float required_pulse = required_length / WHEEL_PERIMETER * PULSE_PER_REV+3000;
...
//       pwmValue = constrain(pwmValue, 0, 255);
//     }
//   // totalCounterRA =0; totalCounterLA =0;
//   if ((0.5*(totalCounterRA+totalCounterLA))<=required_pulse) {
//     Serial.println(pwmValue);
//     digitalWrite(motorLpin1, LOW);
//     analogWrite(motorLpin2, 255);
//     digitalWrite(motorRpin1, LOW);
